...
>ローカルでの実行
```sh
[hello_world] $ bundle exec cap install
```
すると次のようなファイルが生成されます。
>アプリケーションのホームディレクトリ
├─  Capfile
...
[![Image from Gyazo](https://i.gyazo.com/0f697a433d3465d36e9cb909f711d3be.png)](https://gyazo.com/0f697a433d3465d36e9cb909f711d3be)
[![Image from Gyazo](https://i.gyazo.com/7b272e34e9d7f272e5afa2f53de6ba3a.png)](https://gyazo.com/7b272e34e9d7f272e5afa2f53de6ba3a)
